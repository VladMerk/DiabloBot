...
from .fake_guild import FakeRole, FakeGuild, FakeChannel
...
def bot():
    ...
    guild.add_member(id=99887701, name='user1', display_name='User 1',
                     discriminator=0, bot=False,
                     joined_at=datetime(2022, 5, 6, 10, 0, 0,
                                        tzinfo=timezone.get_current_timezone()),
                     removed_at=None, roles=[everyone_role, admin_role])
    bot = FakeBot()
    bot.add_guild(guild)
    return bot
