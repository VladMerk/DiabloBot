...
def filter_and_group_users(users: QuerySet,
                           date_field: str,
...
def get_user_count_by_date(users: QuerySet,
                           start_date: datetime.datetime,
                           end_date: datetime.datetime):

    joined_users_grouped = filter_and_group_users(users, 'joined_at', start_date, end_date)
    removed_users_grouped = filter_and_group_users(users, 'removed_at', start_date, end_date)
